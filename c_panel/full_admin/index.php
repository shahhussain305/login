...
if(!isset($_SESSION['role']) || empty($_SESSION['role']) || intval($_SESSION['role']) != 3){header("Location: ../../index.php?msg=invalid request!");}
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="<?php echo($method->baseUrl()); ?>/assets/bootstrap4/css/admin/custom.css">
    <!-- Optional JavaScript -->
    ...
    <script src="<?php echo($method->baseUrl()); ?>/assets/jquery/admin/Admin.js" ></script>
    <script src="<?php echo($method->baseUrl()); ?>/assets/jquery/admin/admin_functions.js" ></script>
